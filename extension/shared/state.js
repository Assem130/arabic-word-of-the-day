(function (root, factory) {
  ...
  function createDefaultSrsItem(wordId, initialDateKey) {
    ...
    // Preserve string-fixture IDs; the vocabulary index canonicalizes wN aliases
    // to numbers only for the numeric corpus.
    const numericId = typeof wordId === "number"
      ? wordId
      : (/^\d+$/.test(String(wordId)) ? Number(wordId) : null);
