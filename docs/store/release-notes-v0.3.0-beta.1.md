...
| --- | ---: | --- |
| `kalimat-chrome-0.3.0.zip` | 498,259 bytes | `f4bf311a774160aaef2cf42e1c2cf0ca93d02107bf1e18d5ad3daee600bd9f59` |
| `kalimat-firefox-0.3.0.zip` | 498,354 bytes | `14e42e983600b342dfc8e17a30a0179f3d46592cf0bd3ef7728fb82408d7ffd4` |
...
- `node --test tests/*.test.js extension/tests/*.test.js` — pass, 345 tests. The first managed-Windows run hit sandbox-only `spawn EPERM`; the identical command passed with permitted child-process execution.
...
- `node test.js` — نجح.
- الاختبارات الموحّدة — نجحت جميع الاختبارات الـ345 بعد إعادة التشغيل المسموح بها بسبب قيد `spawn EPERM` في Windows المُدار.
